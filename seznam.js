...
/* Najdeme prvek s ID 'menu-tlacitko'V souboru spolecne.js najděte pomocí document.querySelector prvek s id menu-tlacitko pomocí document.querySelector vyhledejte prvek s id seznam-filmu.*/
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="${film.odkaz}" class="btn btn-primary">Přehrát</a>
        </div>
      </div>
    </div>
  `;
